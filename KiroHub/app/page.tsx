        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 lg:gap-12">
            <div className="col-span-2 sm:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                <img src="/logo_dark.png" alt="KiroHub" className="h-6" />
                <span className="font-bold">KiroHub</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="https://github.com/TerrySiu98/kirohub/issues" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">社区</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold mb-4">关于</h3>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="https://github.com/TerrySiu98/kirohub" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">关于我们</Link></li>
                <li><Link href="https://github.com/TerrySiu98/kirohub/issues" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">联系我们</Link></li>
          ...
          <div className="mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-4">
              <Link href="https://github.com/TerrySiu98/kirohub" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
